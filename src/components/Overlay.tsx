    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Rajit Shrivastava.</h1>
                <p className="text-xl md:text-2xl font-light text-gray-300">ML Researcher in Astrophysics.</p>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Applying ML to <br/><span className="text-blue-500">astronomical data</span> & galaxy research.</h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Expertise in Python, <br/><span className="text-purple-500">YOLO & CNNs</span> for astronomy.</h2>
            </div>
        </motion.div>
    </div>
  );
