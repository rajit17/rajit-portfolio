...
const skills = [
  { category: "Programming", items: ["Python", "MATLAB", "BlueJ", "Scientific Computing"] },
  { category: "AI/ML & Astronomy", items: ["CNNs", "YOLO", "Object Detection", "Data Augmentation", "Polarization Analysis", "Galaxy Classification"] },
  { category: "Tools & Software", items: ["Aladin Sky Atlas", "DS9", "COMSOL", "ANSYS", "React", "PyQt"] },
];
