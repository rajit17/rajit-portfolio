...
const ARTICLES = [
  {
    title: "Building BRAHMa: ML for Galaxy Classification",
    excerpt: "How we developed a fast, end-to-end YOLO framework for detecting galactic bars with 99% accuracy, outperforming prior research.",
    category: "Research",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "My journey from pursuing an M.Sc. in Physics to applying cutting-edge ML techniques in astrophysics research and astronomical data analysis.",
    category: "Journey",
    readTime: "6 min read",
  ...
  {
    title: "COMSOL Simulations in Computational Physics",
    excerpt: "Deep dive into multi-physics simulations covering electromagnetic induction, heating, and magnetic phenomena using COMSOL Multiphysics.",
