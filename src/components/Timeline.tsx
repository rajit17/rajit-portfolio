...
const TIMELINE_DATA = [
  {
    ...
    description: "Masters in Science with 8.79/10 CGPA. Focus on astrophysics, computational physics, and machine learning applications to astronomical data.",
    type: "education",
  },
  {
    year: "Mar 2025",
    title: "M.Sc. Project - BRAHMa",
    org: "IIT Indore",
    description: "Developed a YOLO-OBB framework for galactic bar detection achieving 99% accuracy. Created synthetic galaxy datasets and validated with real Legacy Survey data.",
    type: "work",
  },
  {
    year: "Jan 2025 – Feb 2025",
    title: "Winter Intern at ISRO",
    org: "Sriharikota",
    description: "Developed CT reconstruction workflows for rocket phantoms and modernized OSCaR code, improving interface usability and resolving library issues.",
    type: "work",
  },
  {
    year: "Mar 2025",
    title: "Polarization Research Project",
    org: "NIT Bhopal",
    description: "Developed an automated Python pipeline to process stellar data and extract accurate fluxes. Computed precise polarization metrics validated with standard catalogs.",
    type: "research",
  },
  {
    year: "2020 - 2023",
    title: "B.Sc. Physics (Hons)",
    org: "Banaras Hindu University, Varanasi",
    description: "Bachelors in Science with 7.51/10 CGPA. Strong foundation in classical mechanics, electromagnetism, quantum mechanics, and experimental physics.",
    type: "education",
  },
];
