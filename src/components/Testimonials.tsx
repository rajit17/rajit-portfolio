...
const TESTIMONIALS = [
  ...
  {
    quote: "His exceptional academic profile (BHU 7.51, JAM AIR 1640, MANIT 8.79 CGPA) reflects dedication to research. He is disciplined, sincere with excellent communication skills, and I'm confident he'll bring the same excellence to any doctoral program.",
    name: "Dr. Santanu Pakhira",
    role: "Academic Reference, MANIT Bhopal",
    initials: "SP",
  },
];
